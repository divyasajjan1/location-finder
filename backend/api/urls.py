...
from .views import LandmarkPredictionView, LandmarkListView, RecalculateTravelView, ScrapeLandmarkView, BulkImageUploadView, TrainModelView, LandmarkChatView
